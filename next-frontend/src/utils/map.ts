...
import type { DirectionsData } from "./models";
...
export class Map {
  ...
  async addRouteWithIcons(routeOptions: {
    routeId: string;
    startMarkerOptions: Omit<MarkerOptions, "icon">;
    endMarkerOptions: Omit<MarkerOptions, "icon">;
    carMarkerOptions: Omit<MarkerOptions, "icon">;
    directionsResponseData?: DirectionsData;
  }) {
